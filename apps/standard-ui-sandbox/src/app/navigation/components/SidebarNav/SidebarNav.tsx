...
import { Flex, Surface, createFocusRing } from '@noodlestan/standard-ui';
...
export const SidebarNav: Component = () => {
    ...
    const { $root } = createFocusRing({ inset: true });

    return (
        <Surface variant="panel" stretch="height" overflow="y-auto">
            <Flex
                tag="nav"
                direction="column"
                padding="m"
