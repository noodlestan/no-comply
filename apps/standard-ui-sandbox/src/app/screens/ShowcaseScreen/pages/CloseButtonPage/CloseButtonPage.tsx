...
import { CloseButton } from '@noodlestan/standard-ui';
import { type Component } from 'solid-js';

import { findComponent } from '../../../../../data';
import { ComponentMeta, DemoGroup, DemoItem, DemoPage } from '../../../../components';

import styles from './CloseButtonPage.module.css';

export const CloseButtonPage: Component = () => {
    const handlePress = () => console.info('Click');

    const COMPONENT = findComponent('CloseButton');

    return (
        <DemoPage title="CloseButton" classList={staticClassList(styles, 'CloseButtonPage')}>
