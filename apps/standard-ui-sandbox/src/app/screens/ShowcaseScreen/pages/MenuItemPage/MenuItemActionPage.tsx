...
import { Menu, MenuItemAction } from '@noodlestan/standard-ui';
...
import styles from './MenuItemActionPage.module.css';
...
export const MenuItemActionPage: Component = () => {
    const handlePress = () => console.info('Click');

    const COMPONENT = findComponent('MenuItemAction');

    return (
        <DemoPage title="MenuItemAction" classList={staticClassList(styles, 'MenuItemActionPage')}>
