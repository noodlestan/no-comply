...
import { DataValue } from '@noodlestan/standard-ui';
import { type Component } from 'solid-js';

import { findComponent } from '../../../../../data';
import { ComponentMeta, DemoGroup, DemoItem, DemoPage } from '../../../../components';

import styles from './DataValuePage.module.css';
...
export const DataValuePage: Component = () => {
    ...
    return (
        <DemoPage title="DataValue" classList={staticClassList(styles, 'DataValuePage')}>
