...
import styles from './ComponentPlaygroundExample.module.scss';

export const ComponentPlaygroundExample: Component = () => {
	const { currentExample } = useComponentExamples();

	const classList = staticClassList(styles, ['ComponentPlaygroundExample']);
			...
			<Flex direction="column" stretch="height">
				<Suspense fallback={'LOADING...'}>
					...
					<Scrollable y>
						...
						<Show when={parsed()}>
							<ComponentPlaygroundPreview example={currentExample() as ReadyExampleAPI} />
						</Show>
					</Scrollable>
				</Suspense>
			</Flex>
