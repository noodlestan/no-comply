...
**Mandatory READ Directive** – an instruction to: 1. Read a specific file, or specific resources within it; 2. Immediately read all the files listed under its `## Mandatory Reading` section. Example: `– ::READ .agents/domains/tasks/index.md`.
