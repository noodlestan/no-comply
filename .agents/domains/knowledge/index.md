...
- IMPORTANT RULE: Agents MUST NOT read knowledge files unless listed under Mandatory Reading sections or requested to do so by the instructions or by the user. (#hoist).
