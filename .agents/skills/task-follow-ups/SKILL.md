...
description: Use when requested, typically at the end of a task, to synthetise current context into a file with changes made and identified follow-up tasks.
---

When requested, generate a Follow Ups file for the current task.
