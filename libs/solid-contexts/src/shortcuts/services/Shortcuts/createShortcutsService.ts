...
import type { UICommandController, UIControllerName, UIShortcut } from '../../../controller';
...
export const createShortcutsService = (contexts: ActiveContextsServiceAPI): ShortcutsServiceAPI => {
