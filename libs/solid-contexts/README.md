...
> Context-aware services and providers for SolidJS [SolidJS](https://www.solidjs.com/) applications and component libraries.

This package is part of the [[No Comply]](https://no-comply.noodlestan.org/) project.
