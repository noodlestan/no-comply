...
- Add `mixin:standard:sized-content` — [spec](./specifications/mixin-standard-sized-content.md)
- Add `mixin:standard:content-palette` — [spec](./specifications/mixin-standard-content-palette.md)
- Add `mixin:standard:compose-colors` — [spec](./specifications/mixin-standard-compose-color.md)
- Add `mixin:standard:badge` — [spec](./specifications/mixin-standard-badge.md)
- Add `component:standard:badge` — [spec](./specifications/component-standard-badge.md)
- Refactor `Icon` to use `SizedContent` — [spec](./specifications/refactor-icon.md)
- Refactor `SizedAction` to compose `SizedContent` — [spec](./specifications/refactor-sized-action.md)
- Remove `mixin:standard:content-color` — [spec](./specifications/remove-content-color.md)
- Remove `mixin:standard:sized-icon` — [spec](./specifications/remove-sized-icon.md)
